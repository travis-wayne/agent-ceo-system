      ...
      <div className="flex-1 overflow-auto">
        <div className="relative">
          ...
          <div className="relative pl-14 pr-4 py-4">
            ...
            <div className="mb-1">
              <span className="font-medium">Email sent</span> by{' '}
          ...
          <div className="relative pl-14 pr-4 py-4">
            ...
            <div className="mb-1">
              <span className="font-medium">Meeting scheduled</span> with{' '}
          ...
          <div className="relative pl-14 pr-4 py-4">
            ...
            <div className="mb-1">
              <span className="font-medium">Activity created</span> by{' '}
              <span className="font-medium">Phillip Jensen</span>
            </div>
            <div className="text-sm text-gray-500 mb-2">
              Qonto Strategy Meeting - 15 Nov. 2023
            </div>
            <div className="flex items-center text-xs text-gray-500">
              <Clock className="h-3 w-3 mr-1" />
              11:20
          ...
          <div className="relative pl-14 pr-4 py-4">
            ...
            <div className="mb-1">
              <span className="font-medium">Email sent</span> to{' '}
