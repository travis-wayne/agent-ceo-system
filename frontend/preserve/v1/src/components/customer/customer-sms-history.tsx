        ...
        const mockMessages: SmsMessage[] = [
          {
            id: "1",
            content:
              "Hi! Just a reminder that we have a meeting next week about the contract renewal.",
          ...
          {
            id: "2",
            content: "Thanks for the reminder. We look forward to the meeting!",
            sentAt: new Date(
          ...
          },
          {
            id: "3",
            content:
              "We've sent you the contract proposal via email. Can you confirm that you received it?",
        ...
        {loading ? (
          ...
          <div className="rounded-md border border-dashed p-6 text-center">
            ...
            <p className="text-muted-foreground text-sm mt-1">
              There is no SMS history for this customer yet.
            </p>
