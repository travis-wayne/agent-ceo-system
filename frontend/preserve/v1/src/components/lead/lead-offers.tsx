      ...
      {offers.length > 0 ? (
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div>
                        ...
                        <CardDescription className="mt-1">
                          {formatCurrency(offer.totalAmount)} • Created{" "}
                        ...
                        <AccordionItem value="items">
                          <AccordionTrigger>
                            <span className="text-sm font-medium">
                              Products and services ({offer.items.length})
                            </span>
                          </AccordionTrigger>
                          <AccordionContent>
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                ...
                                className="gap-2"
                              >
                                <UserCheck className="h-4 w-4" /> Mark as
                                accepted
                              </Button>
                            </TooltipTrigger>
                            <TooltipContent>
                              <p>Mark the offer as accepted by the customer</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Button
                                ...
                                className="gap-2"
                              >
                                <X className="h-4 w-4" /> Mark as rejected
                              </Button>
                            </TooltipTrigger>
                            <TooltipContent>
                              <p>Mark the offer as rejected by the customer</p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      </>
        ...
        <div className="text-center py-10 border rounded-lg bg-muted/10">
          ...
          <p className="text-muted-foreground mb-4">
            You haven't created any offers for {lead.name} yet
          </p>
          <Button onClick={onCreateOffer} className="gap-2">
